        ...
        <div className={this.props.sidebar ? "faqwindow" : "faqwindow lg"}>
          ...
          <div className="qa">
            ...
            <div className="a">
              ...
              <div className="at">
                ...
                through Python. It is designed to adapt to the learning style of
                the user.
              </div>
            </div>
          </div>
          <div className="qa">
            ...
            <div className="a">
              <div className="adiv">A</div>
              <div className="at">
                When a user registers with IndiCode, they are given three
                options. These are (1) The Index Of Learning Style Questionnaire
                (2) Interactive Learnning Style Portal (3) Standard approach.
              </div>
            </div>
          </div>
          <div className="qa">
            ...
            <div className="a">
              <div className="adiv">A</div>
              <div className="at">
                Not at all! IndiCode is designed for beginners, so please try it
          ...
          <div className="qa">
            ...
            <div className="a">
              <div className="adiv">A</div>
              <div className="at">
                IndiCode keeps a record of your progress but also how frequent
                you access the site and complete a quiz! Keep your streak up and
                watch your programming skills improve daily!
              </div>
            </div>
          </div>
        </div>
